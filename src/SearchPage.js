...
export default function SearchPage() {
  ...
  useEffect(() => {
    const fetchFilteredProspects = async () => {
      ...
      if (
        ...
        // First API call
        const response1 = await fetch("http://192.168.1.36:5032/api/v1/fetchLeads", {
          method: "POST",
          headers: {
        ...
        // Second API call
        const response2 = await fetch("http://192.168.1.36:5032/api/v1/fetchLeads2", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const handleDownload = async () => {
    setIsLoading(true);
    try {
      const response = await fetch("http://192.168.1.36:5032/api/v1/fetchLeads1", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
